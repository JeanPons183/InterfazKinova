...
#ifndef PROTOBUF_InterconnectCyclic_2eproto__INCLUDED
#define PROTOBUF_InterconnectCyclic_2eproto__INCLUDED
...
namespace protobuf_InterconnectCyclic_2eproto {
...
template <> struct is_proto_enum< ::Kinova::Api::InterconnectCyclic::ServiceVersion> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Kinova::Api::InterconnectCyclic::ServiceVersion>() {
  return ::Kinova::Api::InterconnectCyclic::ServiceVersion_descriptor();
}
...
#endif  // PROTOBUF_InterconnectCyclic_2eproto__INCLUDED
