#ifndef __INTERCONNECTCYCLICCLIENT_H__
#define __INTERCONNECTCYCLICCLIENT_H__
...
namespace Api
{
	namespace InterconnectCyclic
	{
		...
		{
			eUidRefresh = 0xf0001,
			eUidRefreshCommand = 0xf0002,
			eUidRefreshFeedback = 0xf0003,
			eUidRefreshCustomData = 0xf0004,
		};
		
		class InterconnectCyclicClient
		{
			static const uint32_t m_serviceVersion = 1;
			static const uint32_t m_serviceId = eIdInterconnectCyclic;
		...
		public:
			InterconnectCyclicClient(IRouterClient* clientRouter);
